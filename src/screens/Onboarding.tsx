 ...
 */
export const SOURCE_KEY = 'oneline.source.v1';
...
const SLIDES: { icon: string; title: string; body: string }[] = [
  {
    icon: '✏️',
    title: 'One line. Thirty seconds.',
    body: 'The journal you’ll actually keep. No blank-page dread, no guilt — one honest line about today, and you’re done.',
  },
  {
    icon: '⏳',
    title: 'Next year, today gets magical',
    body: 'Every day, OneLine shows you what you wrote on this exact date in past years. Ordinary days become a story you’ll reread for life.',
  },
  {
    icon: '🔒',
    title: 'Nobody reads it but you',
    body: 'No account. No cloud. No tracking. Your journal lives only on this iPhone — private by architecture, not by promise.',
  },
];
      ...
      <View style={[styles.container, { backgroundColor: theme.bg }]}>
        <View style={styles.sourceWrap}>
          <Text style={[styles.title, { color: theme.text }]}>
            Where did you hear about OneLine?
          </Text>
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.bg }]}>
      ...
      <View style={styles.footer}>
        ...
        <PillButton theme={theme} label={last ? 'Start writing' : 'Continue'} onPress={next} />
      </View>
    </View>
  );
}
